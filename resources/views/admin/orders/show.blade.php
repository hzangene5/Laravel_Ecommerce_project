    ...
    <div class="col-xl-12 col-md-12 mb-4 p-5 bg-white">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" value="{{ $order->user->name == null ? 'نام کاربر' : $order->user->name }}" disabled>
            </div>

            <div class="form-group col-md-3">
                <label> کد کوپن</label>
                <input class="form-control" type="text" value="{{ $order->coupon_id == null ? 'استفاده شده' : $order->coupon->name }}" disabled>
            </div>
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" value="{{verta( $order->created_at)->format('y-n-j H:i')}}" disabled>
            </div>
