    ...
    <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" value="{{verta( $category->created_at)->format('y-n-j H:i')}}" disabled>
            </div>
            ...
            <hr>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label> خصوصیت های قابل فیلتر</label>
                        <div class="form-control div-disabled">
