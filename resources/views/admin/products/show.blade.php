    ...
    <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" value="{{verta( $product->created_at)->format('y-n-j H:i')}}" disabled>
            </div>
                    ...
                    <div class="card card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" value="{{ $variation->date_on_sale_from == null ? null : verta($variation->date_on_sale_from) }}" disabled class="form-control">
                            </div>

                            <div class="form-group col-md-3">
                                <label> تاریخ پایان حراجی </label>
                                <input type="text" value="{{ $variation->date_on_sale_to == null ? null : verta($variation->date_on_sale_to) }}" disabled class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="{{ url(env('PRODUCT_IMAGES_UPLOAD_PATH') . $image->image) }}" alt="{{ $product->name }}">
                </div>
            </div>
            @endforeach
