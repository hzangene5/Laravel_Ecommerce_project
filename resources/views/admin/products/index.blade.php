...
<div class="row">
  ...
  <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
    <div class="d-flex flex-column text-center flex-md-row justify-content-md-between mb-4">
      ...
      <div> <a class="btn btn-sm btn-outline-primary" href="{{route('admin.products.create')}}">
            ...
            <th>
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  ...
                  <a href="{{ route('admin.products.category.edit' , ['product' => $product->id]) }}" class="dropdown-item text-right"> ویرایش دسته بندی و خصوصیت </a>
