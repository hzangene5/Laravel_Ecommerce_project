        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
            <div class="slider-single-img slider-animated-1">
              <img class="animated" src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $slider->image) }}"
               alt="{{ $slider->image }}" />
            </div>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4">
        <div class="single-banner mb-30 scroll-zoom">
          <a href="#">
            <img class="animated" src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $banner->image) }}" alt="" />
          </a>
      ...
      <div class="col-lg-6 col-md-6">
        <div class="single-banner mb-30 scroll-zoom">
          <a href="{{ $banner->button_link }}"><img class="animated" src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $banner->image) }}" alt="" /></a>
            ...
            <div class="ht-product-inner">
              <div class="ht-product-image-wrap">
                ...
                <div class="ht-product-action">
                  <ul>
                    <li>
                      <a href="#" data-toggle="modal" data-target="#productModal-{{$product->id}}"><i class="sli sli-magnifier"></i>
                        <span class="ht-product-action-tooltip"> مشاهده سریع
                        </span></a>
                    </li>
                    <li>
                      @auth
                      ...
                      <a href="{{ route('home.wishlist.remove', ['product' => $product->id]) }}">
                        ...
                        <span class="ht-product-action-tooltip"> به لیست علاقمندی ها اضافه شده است
                        </span>
                      </a>
                      @else
                    ...
                    <li>
                      <a href="{{ route('home.compare.add', ['product' => $product ])}}">
                        <i class="sli sli-refresh"></i><span class="ht-product-action-tooltip"> مقایسه
                        </span></a>
                    </li>
                  </ul>
                </div>
...
<div class="banner-area pt-100 pb-120">
  <div class="container">
    <div class="row">
      @foreach ($indexBottomBanners as $banner)
      <div class="col-lg-6 col-md-6 text-right">
        <div class="single-banner mb-30 scroll-zoom">
          <a href="{{ $banner->button_link }}"><img src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $banner->image) }}" alt="" /></a>
          ...
          <div class="col-md-5 col-sm-12 col-xs-12">
            ...
            <div class="quickview-wrap mt-15">
              <div class="quickview-slide-active owl-carousel nav nav-style-2" role="tablist">
                ...
                @foreach($product->images as $image)
                <a data-toggle="tab" href="#pro-{{$image->id}}"><img src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH') . $image->image) }}" alt="" /></a>
                @endforeach
              </div>
            </div>
          </div>
